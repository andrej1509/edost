...
2. edost_weight - вес в граммах
3. edost_strah - сумма для страховки в рублях
4. edost_lenght - длина посылки (можно не указывать)
...
require($_SERVER['DOCUMENT_ROOT'].'/cms/plugins/delivery_service/edost_class.php');//подключение класса edost
